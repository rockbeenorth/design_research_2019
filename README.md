...
Главный критерий отбора экспертов — этот человек должен был принимать решение о найме дизайнеров в продуктовые команды за последние полгода (на момент проведения оценки).
